...
- ASP.NET
    ...
    - 브라우저 실행 시 NET::ERR_CERT_INVALID 연결 비공개 설정 이런 화면 나오면
        - 
## 9일차 (07.22)
- ASP.NET Core MVC
    - MVC 리뷰
...
- ASP.NET Core 포트폴리오 웹사이트, MyPortfolio
    ...
    23. /Controller/BoardController.cs를 생성(모델, 뷰 연결)
        - Entity Framework를 사용하여 뷰가 포함된 MVC컨트롤러
        <img src="https://raw.githubusercontent.com/inje98/basic-aspnet-2024/main/images/an0004.png" width="730">
...
- ASP.NET
    ...
    4. 페이징!
        ...
        - 스크롤 페이징, 번호 페이징
        - 번호 페이징
            1. BoardController.cs Index() 액션매서드 내 FromSql()로 변경(비동기 적용 안됨, 비동기 부분 제거)
            2. 페이징용 쿼리 작성
...
- ASP.NET Core 포트폴리오 웹사이트, MyPortfolio
    1. 프로젝트 화면 DB연동하기
        ...
        - View/Home/Project.cshtml DB연동 내용추가 -> 프로젝트에 DB
